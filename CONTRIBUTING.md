# Contributing to @release-change/approve-bot

Thank you for your interest and efforts to contribute to @release-change/approve-bot. All work done is available on GitHub.
...
@release-change/approve-bot is using [GitHub issues](https://github.com/release-change/approve-bot/issues) to manage feature requests and bugs. Before opening an issue or a pull request, try to ensure your problem or feature request has not been already reported or fixed.

### Feature requests

Feature requests by the community are highly encouraged. Feel free to submit a new one filling the information requested in the [feature request template](https://github.com/release-change/approve-bot/issues/new?template=feature-request.yml).

### Bug reports

Please try to be as detailed as possible in your report and fill the information requested in the [bug report template](https://github.com/release-change/approve-bot/issues/new?template=bug-report.yml).
...
- you have [pnpm](https://pnpm.io) at version 11.0.0+ installed,
...
#### Steps
1. [Go to the repository](https://github.com/release-change/approve-bot) and fork it using your own GitHub account,
2. clone your repository:

        git clone git@github.com:YOUR_USERNAME/approve-bot.git
3. go to the root of the repository and run:

        cd @release-change/approve-bot
        pnpm install
4. run TypeScript and the test suites in watch mode:

        pnpm dev

Awesome! You are now able to contribute to @release-change/approve-bot.
...
@release-change/approve-bot follows the rules defined by the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) specification.
...
@release-change/approve-bot uses [commitlint](https://commitlint.js.org) to help you create valid commit messages.
...
@release-change/approve-bot uses [Biome](https://biomejs.dev) for linting and formatting. Biome linting and formatting will be automatically checked and run when committing.
...
@release-change/approve-bot uses [Vitest](https://vitest.dev) for writing and running tests.
