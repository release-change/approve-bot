...
The latest version of approve-bot is currently supported with security updates.
...
`npm` 10.9.0+ and `pnpm` 11.0.0+ are supported. **`yarn` is not supported.**

## Reporting a vulnerability

Please report (suspected) security vulnerabilities via [GitHub’s security advisory reporting system](https://github.com/release-change/approve-bot/security/advisories/new).
...
approve-bot does not support other reporting platforms: all security vulnerabilities must be made via the GitHub Advisory system.

List of some (though not all) platforms **which are not supported:**
- direct e-mail or communication to approve-bot contributors (Discord or Slack),
- Stack Overflow.
